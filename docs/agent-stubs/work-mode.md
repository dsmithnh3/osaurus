...
- `Storage/` — work database / issue persistence (see [WORK.md](../WORK.md) and **CLAUDE.md** at the repository root — data locations for `work.db`)
...
- Engines are **Services**, not `ObservableObject`—keep UI in **Managers** / **Views** (**CLAUDE.md** at the repository root).
